...
SELECT
  ...
  c.biometric_timestamp AT TIME ZONE 'UTC' AT TIME ZONE 'America/Los_Angeles',
  'WHOOP'::text,
  ...
  c.aircraft_timestamp AT TIME ZONE 'UTC' AT TIME ZONE 'America/Los_Angeles',
...
SELECT
  ...
  b.id::text,
  b.event_timestamp,
  b.event_timestamp AT TIME ZONE 'UTC' AT TIME ZONE 'America/Los_Angeles',
...
SELECT
  ...
  u.id::text,
  u.event_timestamp,
  COALESCE(u.event_timestamp_pdt, u.event_timestamp AT TIME ZONE 'UTC' AT TIME ZONE 'America/Los_Angeles'),
